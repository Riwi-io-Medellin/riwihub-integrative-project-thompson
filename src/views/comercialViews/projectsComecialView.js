export function projectsComercialView() {
  return `
    <div class="page active" id="page-projects">
      <h1 class="section-title">Catálogo de <span class="text-gradient">Proyectos</span></h1>
      <div class="stats-row">
        <div class="stat-card"><div class="stat-val">23</div><div class="stat-label">Clientes contactados</div><div class="stat-change">+4</div></div>
        <div class="stat-card"><div class="stat-val">8</div><div class="stat-label">Citas esta semana</div><div class="stat-change">+2</div></div>
        <div class="stat-card"><div class="stat-val" id="notifCount">2</div><div class="stat-label">Notificaciones nuevas</div><div class="stat-change">Pendientes</div></div>
      </div>
      <div class="projects-layout">
        <div class="ai-chat">
          <div class="ai-chat-header">🤖 <span>Asistente IA</span> — Busca proyectos</div>
          <div class="ai-messages" id="aiMessages">
            <div class="ai-msg bot">Cargando asistente...</div>
          </div>
          <div class="ai-input-wrap">
            <input type="text" id="aiInput" placeholder="Buscar proyectos...">
    ...
    <!-- Modal de proyecto va aquí, dentro de su vista -->
